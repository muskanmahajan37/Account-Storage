...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        self.l = Label(top, text="ENTRY_PASSWORD: ", font=('Courier', 14), justify=CENTER)
        self.l.pack()
...
def readfile():
    f = open("C:\\Users\\ag16000\\Desktop\\GIT\\PRACTISE\\PY_PROJECT\\Account-Storage-master\\emails.txt", "r")
    count = 0
